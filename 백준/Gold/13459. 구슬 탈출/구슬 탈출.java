...
//				System.out.println("------------");
//				System.out.println("이동전: " + point.bx + " " + point.by + " " + point.rx + " " + point.ry);
...
//						System.out.print("파랑 있음");
						nrx -= dx[d];
						nry -= dy[d];
					}
					
//					System.out.println("이동후: " + nbx + " " + nby + " " + nrx + " " + nry);
